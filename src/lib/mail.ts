...
<body>
  <div class="email-wrapper">
    <div class="email-content">
      ...
      <p>
        We received a request to verify your email address for your MS Academy account.
...
`})
    ...
    console.log("error in verifying email (mail.ts)", error instanceof Error ? error.message : error);
    return {
      success: false,
